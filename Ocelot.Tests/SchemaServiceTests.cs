...
namespace NightlyCode.Database.Tests {
    ...
    public class SchemaServiceTests {
        ...
        public async Task UpdateSchema() {
            ...
            Assert.AreEqual(1, created.Index[0].Columns.Count());
        ...
        public async Task DontUpdateTwice() {
            ...
            client.Setup(s => s.ReaderAsync(It.IsAny<Transaction>(), It.IsAny<string>(), It.IsAny<IEnumerable<object>>())).Returns<Transaction, string, IEnumerable<object>>((transaction, command, parameters) => {
                object data;
