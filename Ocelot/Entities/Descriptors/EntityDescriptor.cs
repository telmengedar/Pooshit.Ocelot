...
namespace Pooshit.Ocelot.Entities.Descriptors {
    ...
    public class EntityDescriptor {
        readonly Dictionary<string, EntityColumnDescriptor> properties = new();
        readonly Dictionary<string, EntityColumnDescriptor> columndescriptors = new();
        readonly List<IndexDescriptor> indices = new();
        readonly List<UniqueDescriptor> uniques = new();
        ...
        internal static EntityColumnDescriptor CreateColumnDescriptor(PropertyInfo property) {
            ...
            EntityColumnDescriptor columndescriptor = new(columnname, property) {
        ...
        public static EntityDescriptor Create(Type type) {
            ...
            EntityDescriptor descriptor = new(tablename);
            ...
            foreach(KeyValuePair<string, IndexInformation> kvp in indices)
