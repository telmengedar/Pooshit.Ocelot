...
public interface IEntityManager {
    ...
    /// </summary>
    /// <typeparam name="T">type of entity for which to drop table / view</typeparam>
    ...
    /// get an operation used to delete data from database
    /// </summary>
    /// <param name="table">name of table of which to delete data</param>
    /// <returns>operation to use</returns>
    DeleteOperation Delete(string table);
    ...
    /// </summary>
    /// <typeparam name="T">type of entity for which to insert rows</typeparam>
    /// <returns>operation to use</returns>
