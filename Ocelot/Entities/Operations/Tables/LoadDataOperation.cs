...
public class LoadDataOperation : WhereTokenOperation {
    ...
    /// <param name="parameters">parameters for statement</param>
    /// <returns>loaded data</returns>
    public IAsyncEnumerable<T> ExecuteSetAsync<T>(params object[] parameters) {
    ...
    /// <param name="parameters">parameters for statement</param>
    /// <returns>loaded data</returns>
    public IAsyncEnumerable<T> ExecuteSetAsync<T>(Transaction transaction, params object[] parameters) {
    ...
    /// <param name="parameters">parameters to use</param>
    /// <returns>loaded entities</returns>
    public IAsyncEnumerable<T> ExecuteTypesAsync<T>(Transaction transaction, Func<Row, T> assignments, params object[] parameters)
    {
    ...
    /// <param name="parameters">parameters to use</param>
    /// <returns>loaded entities</returns>
    public IAsyncEnumerable<T> ExecuteTypesAsync<T>(Func<Row, T> assignments, params object[] parameters)
    {
    ...
    PreparedLoadOperation Prepare(bool dbPrepare) {
        ...
        if(!ReferenceEquals(LimitStatement, null))
            preparator.AppendField(LimitStatement, client.DBInfo, null);
