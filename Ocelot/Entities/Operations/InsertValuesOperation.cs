...
namespace Pooshit.Ocelot.Entities.Operations {
    ...
    public class InsertValuesOperation<T> {
        ...
        object[] insertvalues;
        bool returnid;
        IDatabaseOperation selectOperation;
        ...
        /// <summary>
        /// adds a select operation to use for inserting data
        /// </summary>
        /// <param name="selectOperation">operation to use to insert data</param>
        /// <returns>insert operation for fluent behavior</returns>
        public InsertValuesOperation<T> Select(IDatabaseOperation selectOperation) {
        ...
        public PreparedOperation Prepare() {
            ...
            if (selectOperation != null) {
                selectOperation.Prepare(preparator);
            }
            else {
                first = true;
                preparator.AppendText("VALUES(");
                ...
                if (returnid) {
                    ...
                    return preparator.GetReturnIdOperation(dbclient, false);
                }
            }
