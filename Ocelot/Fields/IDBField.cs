...
public interface IDBField {
    ...
    /// <summary>
    /// field to use in expressions when referencing a <see cref="T:bool"/> parameter
    /// </summary>
    bool Bool { get; }

    /// <summary>
    /// field to use in expressions when referencing typed parameters
    /// </summary>
    T Type<T>();
...
public abstract class DBField : IDBField {
    ...
    /// <param name="lhs">left hand side field</param>
    /// <param name="rhs">right hand side field</param>
    public static DBField operator *(object lhs, DBField rhs)
    {
        throw new NotImplementedException("Method has no implementation since it is only used for typed expressions");
    }
    ...
    /// <param name="lhs">left hand side field</param>
    /// <param name="rhs">right hand side field</param>
    public static bool operator<(object lhs, DBField rhs) {
        throw new NotImplementedException("Method has no implementation since it is only used for typed expressions");
    }
    ...
    /// <param name="lhs">left hand side field</param>
    /// <param name="rhs">right hand side field</param>
    public static DBField operator *(DBField lhs, object rhs)
    {
        throw new NotImplementedException("Method has no implementation since it is only used for typed expressions");
    }
    ...
    /// <param name="lhs">left hand side field</param>
    /// <param name="rhs">right hand side field</param>
    public static bool operator<(DBField lhs, object rhs) {
        throw new NotImplementedException("Method has no implementation since it is only used for typed expressions");
    }
