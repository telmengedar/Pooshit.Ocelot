...
internal static class Converter {
    ...
    static Converter() {
        ...
        specificconverters[new(typeof(string), typeof(Type))] = o => Type.GetType((string)o);
        specificconverters[new(typeof(long), typeof(DateTime))] = v => new DateTime((long)v);
        specificconverters[new(typeof(DateTime), typeof(long))] = v => ((DateTime)v).Ticks;
        specificconverters[new(typeof(Version), typeof(string))] = o => o.ToString();
        specificconverters[new(typeof(string), typeof(Version))] = s => Version.Parse((string)s);
        specificconverters[new(typeof(string), typeof(TimeSpan))] = s => TimeSpan.Parse((string)s);
        specificconverters[new(typeof(long), typeof(Version))] = l => new Version((int)((long)l >> 48), (int)((long)l >> 32) & 65535, (int)((long)l >> 16) & 65535, (int)(long)l & 65535);
        specificconverters[new(typeof(Version), typeof(long))] = v => (long)((Version)v).Major << 48 | ((long)((Version)v).Minor << 32) | ((long)((Version)v).Build << 16) | (long)((Version)v).Revision;
        specificconverters[new(typeof(IntPtr), typeof(int))] = v => ((IntPtr)v).ToInt32();
        specificconverters[new(typeof(IntPtr), typeof(long))] = v => ((IntPtr)v).ToInt64();
        specificconverters[new(typeof(UIntPtr), typeof(int))] = v => ((UIntPtr)v).ToUInt32();
        specificconverters[new(typeof(UIntPtr), typeof(long))] = v => ((UIntPtr)v).ToUInt64();
        specificconverters[new(typeof(int), typeof(IntPtr))] = v => new IntPtr((int)v);
        ...
        specificconverters[new(typeof(string), typeof(Guid))] = v => Guid.Parse((string) v);
        specificconverters[new(typeof(string), typeof(BigInteger))] = v => BigInteger.Parse((string) v);
        specificconverters[new(typeof(long), typeof(BigInteger))] = v => new BigInteger((long) v);
        specificconverters[new(typeof(ulong), typeof(BigInteger))] = v => new BigInteger((ulong) v);
        specificconverters[new(typeof(int), typeof(BigInteger))] = v => new BigInteger((int) v);
        specificconverters[new(typeof(uint), typeof(BigInteger))] = v => new BigInteger((uint) v);
        specificconverters[new(typeof(float), typeof(BigInteger))] = v => new BigInteger((float) v);
        specificconverters[new(typeof(double), typeof(BigInteger))] = v => new BigInteger((double) v);
        specificconverters[new(typeof(decimal), typeof(BigInteger))] = v => new BigInteger((decimal) v);
        specificconverters[new(typeof(byte[]), typeof(BigInteger))] = v => new BigInteger((byte[]) v);
        specificconverters[new(typeof(BigInteger), typeof(string))] = v => ((BigInteger)v).ToString();
        specificconverters[new(typeof(BigInteger), typeof(long))] = v => (long)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(ulong))] = v => (ulong)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(int))] = v => (int)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(uint))] = v => (uint)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(float))] = v => (float)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(double))] = v => (double)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(decimal))] = v => (decimal)(BigInteger)v;
        specificconverters[new(typeof(BigInteger), typeof(byte[]))] = v => ((BigInteger)v).ToByteArray();
    }
